...
namespace UnitTest.IRCParser
{
	...
	class ParserTest
	{
		...
		public void QueryParseTestWithOneTargetAndTrailngParams()
		{
			...
			IRCSharp.Kernel.Parser.IRC.Query query = null;
			...
			Assert.AreEqual(IRCSharp.Kernel.Parser.IRC.ResponseCommand.PRIVMSG, query.Command);
		...
		public void QueryParseTestWithNoPreifxAndNoTrailing()
		{
			...
			Assert.AreEqual(IRCSharp.Kernel.Parser.IRC.ResponseCommand.PING, query.Command);
		...
		public void QueryParseTestWithJoin()
		{
			...
			Assert.AreEqual(IRCSharp.Kernel.Parser.IRC.ResponseCommand.JOIN, query.Command);
		...
		public void QueryParseTesBlank()
		{
			...
			Assert.AreEqual(IRCSharp.Kernel.Parser.IRC.ResponseCommand.NOT_VALID_RESPONSE_COMMAND_TYPE, query.Command);
		...
		public void QueryParseNUmericReply005()
		{
			...
			Assert.AreEqual(IRCSharp.Kernel.Parser.IRC.ResponseCommand.RPL_ISUPPORT, query.Command);
